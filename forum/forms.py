...
class NewTopicForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if is_subforum:
            ...
            if self.user.profile.get_top_group == 'Non présenté' and parent_object.slug != 'Pr-sente-toi-ici':
        ...
        if self.user.profile.get_top_group == 'Non présenté' and (not is_subforum or parent_object.slug != 'Pr-sente-toi-ici'):
             # Allow posting in 'Pr-sente-toi-ici' subforum, but restrict elsewhere if Non présenté
             # If posting directly in a category as a Non présenté, restrict it.
             if is_category:
